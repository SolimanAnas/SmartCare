...
/* ──────────────────────────────────────────────────────────────────────────────
 * c8s6 – Hazardous Materials Awareness
 * ────────────────────────────────────────────────────────────────────────────── */
{
    id: "c8s6",
    shortTitle: "8.6 Hazardous Materials Awareness",
    summary: `<div class="sum-card">
        <h3 style="color:var(--primary-accent);"><svg class="lucide" width="1em" height="1em" aria-hidden="true" focusable="false"><use href="../icons/sprite.svg#cloud-lightning"/></svg> Hazardous Materials Awareness</h3>

        <p>As an EMT, you are trained to the <strong>Awareness Level</strong> under OSHA 29 CFR 1910.120 (HAZWOPER) — the first and most basic level of hazmat training. Your role is to <strong>recognise a hazmat incident, protect yourself, secure the scene, and call for appropriately trained personnel</strong>. You do NOT perform direct hazmat mitigation — your primary responsibility is scene safety, isolation, notification, and patient care in the cold (clean) zone after decontamination. <strong>Attempting to rescue victims from the hot zone without appropriate PPE and training turns you into another victim.</strong></p>

        <div class="highlight-box" style="background:#f8d7da; border-left-color:#dc3545;">
            <strong>CRITICAL — The Golden Rule of Hazmat:</strong> <em>"You cannot help anyone if you become a victim yourself."</em> If you suspect a hazmat incident (unusual odours, dead animals, multiple patients with similar symptoms, visible vapour clouds, chemical containers, or placards) — STOP at a safe distance, assess from upwind and uphill, and do NOT enter the hot zone without appropriate level of PPE and training.
        </div>

        <h4>Hazmat Recognition — The Clues</h4>
        <p>Recognising a hazmat incident requires you to be alert to situational clues. Use the <strong>HAZMAT mnemonic</strong>:</p>
        <ul>
            <li><strong>H</strong> — <strong>H</strong>ear unusual sounds (hissing, popping — escaping gas/ruptured containers)</li>
            <li><strong>A</strong> — <strong>A</strong>pproach cautiously from upwind and uphill. Look for unusual coloured vapour clouds, liquid puddles, or dead animals/insects (a canary-in-the-coalmine sign).</li>
            <li><strong>Z</strong> — <strong>Z</strong>one assessment: identify the hot (contamination), warm (decontamination), and cold (clean) zones.</li>
            <li><strong>M</strong> — <strong>M</strong>arkings and placards: the DOT placard system (NFPA 704 diamond, UN/NA numbers, shipping papers, labels on individual containers).</li>
            <li><strong>A</strong> — <strong>A</strong>ction: isolate the area, deny entry, protect yourself, call for specialised help.</li>
            <li><strong>T</strong> — <strong>T</strong>ype of container and material involved. Look for tanker trucks, railcars, drums, cylinders, and the shape/configuration of the container.</li>
        </ul>

        <h4>DOT Placard System and NFPA 704</h4>
        <p>The <strong>DOT (Department of Transportation) placard system</strong> uses a colour-coded diamond with a hazard class number and UN/NA identification number to identify hazardous materials in transport. Placards are required on all four sides of transport vehicles and on bulk containers.</p>
        <table>
            <thead>
                <tr><th>Hazard Class</th><th>Number</th><th>Placard Colour</th><th>Examples</th></tr>
            </thead>
            <tbody>
                <tr><td>Explosives</td><td>1</td><td>Orange</td><td>Dynamite, fireworks, ammonium nitrate</td></tr>
                <tr><td>Flammable Gases</td><td>2.1</td><td>Red</td><td>Propane, butane, acetylene</td></tr>
                <tr><td>Non-Flammable Gases</td><td>2.2</td><td>Green</td><td>Oxygen, nitrogen, carbon dioxide, compressed air</td></tr>
                <tr><td>Poisonous Gases</td><td>2.3</td><td>White</td><td>Chlorine, ammonia (anhydrous), phosgene, sarin</td></tr>
                <tr><td>Flammable Liquids</td><td>3</td><td>Red</td><td>Gasoline, diesel, ethanol, acetone</td></tr>
                <tr><td>Flammable Solids</td><td>4</td><td>White/Red stripes</td><td>Matches, magnesium, phosphorus, sodium</td></tr>
                <tr><td>Oxidising Substances</td><td>5.1</td><td>Yellow</td><td>Hydrogen peroxide, ammonium nitrate fertiliser</td></tr>
                <tr><td>Organic Peroxides</td><td>5.2</td><td>Yellow</td><td>Benzoyl peroxide, methyl ethyl ketone peroxide</td></tr>
                <tr><td>Toxic (Poisonous) Substances</td><td>6.1</td><td>White</td><td>Cyanide compounds, pesticides, arsenic</td></tr>
                <tr><td>Infectious Substances</td><td>6.2</td><td>White</td><td>Medical waste (regulated), pathogens</td></tr>
                <tr><td>Radioactive Materials</td><td>7</td><td>Yellow/White</td><td>Medical isotopes, industrial radiography sources</td></tr>
                <tr><td>Corrosive Substances</td><td>8</td><td>White (top black, bottom white)</td><td>Sulfuric acid, hydrochloric acid, sodium hydroxide</td></tr>
                <tr><td>Miscellaneous Dangerous Goods</td><td>9</td><td>White with black stripes</td><td>Lithium batteries, dry ice, asbestos, molten sulphur</td></tr>
            </tbody>
        </table>

        <h5>NFPA 704 Diamond</h5>
        <p>The <strong>NFPA (National Fire Protection Association) 704</strong> diamond is a fixed-facility marking (NOT for transport) that uses a four-colour diamond to indicate the hazards of a material in the facility. Each quadrant has a rating of 0 (minimal hazard) to 4 (severe hazard):</p>
        <ul>
            <li><strong>Blue (Left)</strong> — <strong>Health</strong> hazard: 0 = normal, 1 = slightly hazardous, 2 = hazardous, 3 = extreme danger, 4 = deadly.</li>
            <li><strong>Red (Top)</strong> — <strong>Flammability</strong> hazard: 0 = will not burn, 1 = above 200°F, 2 = below 200°F, 3 = below 100°F, 4 = below 73°F.</li>
            <li><strong>Yellow (Right)</strong> — <strong>Reactivity</strong>: 0 = stable, 1 = unstable if heated, 2 = violent chemical change, 3 = shock/heat may detonate, 4 = readily detonates at normal conditions.</li>
            <li><strong>White (Bottom)</strong> — <strong>Special</strong> hazards: OX = oxidiser, W&oline; = water-reactive, SA = simple asphyxiant, COR = corrosive, BIO = biohazard, CRYO = cryogenic.</li>
        </ul>

        <h4>Zones of a Hazmat Incident</h4>
        <p>Hazmat scenes are divided into three zones, each with specific entry requirements:</p>
        <table>
            <thead>
                <tr><th>Zone</th><th>Description</th><th>PPE Required</th><th>Who Enters</th></tr>
            </thead>
            <tbody>
                <tr><td><strong>Hot Zone</strong></td><td>The contaminated area — immediate area around the spill or release. Anyone in this zone is contaminated.</td><td>Level A or B (fully encapsulated vapour-tight suit with SCBA in Level A; splash-protection suit with SCBA in Level B)</td><td>Hazmat Technicians only — NOT EMTs at the Awareness level</td></tr>
                <tr><td><strong>Warm Zone</strong></td><td>The area between hot and cold zones where decontamination (decon) is performed.</td><td>Level B or C (depending on the agent and decon method); chemical-resistant suits, boots, gloves, appropriate respiratory protection</td><td>Decontamination team members (hazmat technicians with some EMT support in appropriate PPE)</td></tr>
                <tr><td><strong>Cold Zone</strong></td><td>The clean area where command post, triage, treatment, and transport are set up. No contaminated patient may enter until cleared by the decon team.</td><td>Standard duty uniform / standard precautions — NO special hazmat PPE required</td><td>EMTs, paramedics, command staff, transport personnel — THIS IS WHERE YOU WORK</td></tr>
            </tbody>
        </table>

        <div class="highlight-box" style="background:#f8d7da; border-left-color:#dc3545;">
            <strong>Critical — The EMT's Zone:</strong> As an EMT trained to Awareness level, you operate in the <strong>COLD ZONE ONLY</strong>. You NEVER enter the hot zone. Your role is to receive decontaminated patients in the cold zone, provide medical care, triage, and arrange transport. Do NOT compromise the cold zone — contaminated patients or equipment must NOT enter the cold zone without decontamination clearance.
        </div>

        <h4>Decontamination (Decon)</h4>
        <p>Decontamination is the process of removing or neutralising hazardous materials from patients, personnel, and equipment. The goal is to prevent further absorption of the contaminant and to protect healthcare workers and facilities from secondary contamination.</p>

        <h5>Types of Decontamination</h5>
        <ul>
            <li><strong>Emergency (Gross) Decontamination:</strong> Rapid removal of bulk contamination — typically done by stripping clothing and rinsing with copious amounts of water. Speed is more important than thoroughness. Clothing removal alone can remove 70–90% of contaminants.</li>
            <li><strong>Technical Decontamination:</strong> A systematic, step-by-step decon process performed by trained decon teams in the warm zone. Involves multiple stations: gross rinse → soap/scrub → rinse → monitoring → dress-out.</li>
            <li><strong>Patient (Medical) Decontamination:</strong> Decon performed specifically for patients with medical needs, balancing the urgency of treatment with the need for decon.</li>
        </ul>

        <h5>Patient Decontamination Principles</h5>
        <ul>
            <li><strong>Clothing removal is the single most effective decon step</strong> — removes 70–90% of contaminants. Cut away clothing carefully (do NOT pull over the head). Double-bag clothing in labelled hazardous waste bags.</li>
            <li><strong>Copious water irrigation</strong> — use tepid water, low pressure to avoid splashing.</li>
            <li><strong>Dry decontamination</strong> — for agents that react with water (e.g., elemental metals like sodium). Brush off dry contaminant first, then consider other methods.</li>
            <li><strong>Chemical-specific decon</strong> — some agents require specific decon solutions (e.g., polyethylene glycol for phenol, soap and water for organophosphates, dilute bleach for biological agents).</li>
            <li><strong>Eye decontamination</strong> — irrigate eyes with copious water or normal saline for at least 15–20 minutes (longer for corrosives). Remove contact lenses. Use Morgan lens if available.</li>
            <li><strong>Wound decontamination</strong> — irrigate wounds copiously before dressing. Do NOT scrub wounds (causes further absorption). Cover with clean dressings after irrigation.</li>
        </ul>

        <h4>Emergency Response Guidebook (ERG)</h4>
        <p>The <strong>ERG (Emergency Response Guidebook)</strong> is the primary field reference for initial hazmat response. Published every 4 years by DOT. It provides guidance for the FIRST 30 MINUTES of a hazmat incident. Key sections:</p>
        <ul>
            <li><strong>Yellow-bordered pages</strong> — List of UN/NA numbers in numerical order. Find the material's UN/NA number, then look up the 3-digit guide number.</li>
            <li><strong>Blue-bordered pages</strong> — List of materials in alphabetical order (chemical names, synonyms). Find the material name → guide number.</li>
            <li><strong>Orange-bordered pages</strong> — The actual response guides (Guide 1XX–3XX). Each guide includes: potential hazards, public safety (isolation distances, evacuation), protective clothing, and emergency response.</li>
            <li><strong>Green-bordered pages</strong> — Table of initial isolation and protective action distances for toxic inhalation hazards (TIH).</li>
            <li><strong>White-bordered pages</strong> — User guide, glossary, classification chart, and notes on specific hazards.</li>
        </ul>

        <div class="highlight-box" style="background:#fff3cd; border-left-color:#856404;">
            <strong>Clinical Pearl — Using the ERG:</strong> When you arrive at a scene with a placard, note the UN/NA number (4-digit number on the placard or orange panel). Open the ERG to the yellow-bordered pages, find the number, and note the Guide number. Turn to the orange-bordered Guide page for response actions. The ERG is designed for the first 30 minutes of response — it is NOT a substitute for hazmat team expertise.
        </div>

        <h4>Common Hazmat Agents and Their Toxidromes</h4>
        <p>Recognising toxidromes (toxic syndromes) helps identify the class of agent and guide initial management:</p>
        <table>
            <thead>
                <tr><th>Toxidrome</th><th>Common Agents</th><th>Key Signs</th><th>Antidote/Treatment</th></tr>
            </thead>
            <tbody>
                <tr><td><strong>Cholinergic (SLUDGEM)</strong></td><td>Organophosphates (nerve agents — sarin, VX, parathion), carbamates</td><td>Salivation, lacrimation, urination, defecation, GI upset, emesis, miosis (pinpoint pupils), muscle fasciculations, bradycardia, seizures, respiratory failure</td><td>Atropine (blocks muscarinic effects) + pralidoxime (2-PAM). Diazepam for seizures.</td></tr>
                <tr><td><strong>Cyanide</strong></td><td>Hydrogen cyanide, smoke inhalation (fires — combustion of plastics, wool, silk, polyurethane)</td><td>Rapid onset: headache, dyspnoea, AMS, seizures, coma, cardiac arrest. Severe metabolic acidosis with elevated lactate, bright red venous blood</td><td>Hydroxocobalamin (Cyanokit) 5 g IV</td></tr>
                <tr><td><strong>Opioid</strong></td><td>Fentanyl, heroin, morphine, oxycodone</td><td>Respiratory depression, miosis (pinpoint pupils), CNS depression, bradycardia, hypotension</td><td>Naloxone (Narcan) — titrate to respiratory rate of 12–16/min</td></tr>
                <tr><td><strong>Hydrocarbon</strong></td><td>Gasoline, kerosene, paint thinner, toluene</td><td>CNS depression, dysrhythmias (myocardial sensitisation to catecholamines), pneumonitis (aspiration)</td><td>Supportive care. Avoid epinephrine (risk of fatal dysrhythmia).</td></tr>
                <tr><td><strong>Corrosives</strong></td><td>Sulfuric acid, hydrochloric acid, sodium hydroxide, ammonia</td><td>Immediate tissue destruction — skin burns, eye damage, airway oedema, GI tract burns. Ammonia causes pulmonary oedema.</td><td>Copious water irrigation. Do NOT neutralise (exothermic reaction causes thermal burn).</td></tr>
            </tbody>
        </table>

        <h4>Hazmat PPE Levels</h4>
        <table>
            <thead>
                <tr><th>Level</th><th>Protection</th><th>When Used</th></tr>
            </thead>
            <tbody>
                <tr><td><strong>A</strong></td><td>Fully encapsulated, vapour-tight suit with SCBA</td><td>Highest respiratory and skin hazard — unknown agents, vapour hazard, agents absorbed through skin</td></tr>
                <tr><td><strong>B</strong></td><td>Splash-proof suit with SCBA (not vapour-tight)</td><td>High respiratory hazard but lower skin hazard — known agents primarily inhalation hazards without significant skin absorption</td></tr>
                <tr><td><strong>C</strong></td><td>Splash-proof suit with air-purifying respirator (APR)</td><td>Known agent, low hazard, adequate oxygen (≥19.5%)</td></tr>
                <tr><td><strong>D</strong></td><td>Standard work uniform</td><td>No respiratory or skin hazard — cold zone operations only</td></tr>
            </tbody>
        </table>

        <div class="highlight-box" style="background:#f8d7da; border-left-color:#dc3545;">
            <strong>NREMT Focus — Key Takeaways:</strong><br>
            • EMTs are trained to AWARENESS level — recognise, call for help, work in the COLD zone<br>
            • NEVER enter the hot zone without appropriate PPE and HAZMAT Technician-level training<br>
            • Patient clothing removal removes 70–90% of contaminants — the most important decon step<br>
            • Use the ERG: UN/NA number → Guide number → response actions (isolation, PPE, first aid)<br>
            • Three zones: HOT (contamination) → WARM (decontamination) → COLD (clean — where you work)<br>
            • The ERG is for the FIRST 30 MINUTES of response — not a substitute for hazmat team expertise<br>
            • Scene approach: APPROACH FROM UPWIND AND UPHILL — always<br>
            • Recognise placards (9 hazard classes) and NFPA 704 diamond (Health/Flammability/Reactivity/Special)
        </div>
    </div>`,
    flashcards: [
        {
            question: "What are the three zones of a hazmat incident and what occurs in each?",
            answer: "1) HOT zone (Exclusion Zone) — contaminated area. Only hazmat technicians in Level A/B PPE. 2) WARM zone (Contamination Reduction Zone) — decontamination performed. 3) COLD zone (Support Zone) — command post, triage, treatment, transport. This is where EMTs work. No contaminated patient enters the cold zone until cleared by decon.",
            category: "Environmental — Hazmat"
        },
        {
            question: "What are the levels of hazmat PPE and their key features?",
            answer: "A — fully encapsulated vapour-tight suit + SCBA (highest protection). B — splash-proof suit + SCBA (high respiratory, lower skin). C — splash-proof suit + APR (air-purifying respirator) — known agent, adequate O₂. D — standard work uniform (cold zone only). EMTs at Awareness level do NOT wear Level A–C.",
            category: "Environmental — Hazmat"
        },
        {
            question: "How do you use the ERG (Emergency Response Guidebook)?",
            answer: "Find the UN/NA number (4-digit number on the placard), look it up in the yellow pages → get the Guide number → turn to the orange Guide page for response actions (isolation, PPE, first aid). Green pages have specific isolation distances for toxic inhalation hazards.",
            category: "Environmental — Hazmat"
        },
        {
            question: "What does the NFPA 704 diamond represent?",
            answer: "Four coloured quadrants: BLUE (left) = Health hazard (0–4), RED (top) = Flammability (0–4), YELLOW (right) = Reactivity (0–4), WHITE (bottom) = Special hazards (OX = oxidiser, W&oline; = water-reactive, SA = simple asphyxiant). 0 = minimal, 4 = severe.",
            category: "Environmental — Hazmat"
        },
        {
            question: "What is the single most effective step in patient decontamination?",
            answer: "CLOTHING REMOVAL — eliminates 70–90% of contaminants. Cut away clothing carefully (do NOT pull over head). Double-bag in labelled hazardous waste bags. Then copious water irrigation (tepid, low pressure). Dry decon (brushing) for water-reactive agents.",
            category: "Environmental — Hazmat"
        },
        {
            question: "What is the SLUDGEM toxidrome and what agent class causes it?",
            answer: "SLUDGEM = Salivation, Lacrimation, Urination, Defecation, GI upset, Emesis, Miosis (pinpoint pupils). Caused by cholinergic agents: organophosphates (nerve agents) and carbamates. Antidote: atropine + pralidoxime (2-PAM). Diazepam for seizures.",
            category: "Environmental — Hazmat"
        },
        {
            question: "What are the 9 DOT hazard classes?",
            answer: "1-Explosives (orange), 2-Gases (red=flammable, green=non-flammable, white=poisonous), 3-Flammable liquids (red), 4-Flammable solids (white/red stripes), 5-Oxidisers/organic peroxides (yellow), 6-Toxic/infectious (white), 7-Radioactive (yellow/white), 8-Corrosives (white/black), 9-Miscellaneous (white/black stripes).",
            category: "Environmental — Hazmat"
        },
        {
            question: "Where should you park the ambulance when approaching a suspected hazmat scene?",
            answer: "UPWIND and UPHILL from the incident. Park at a safe distance, facing away from the scene for rapid departure if conditions change. Do NOT drive through vapour clouds or liquid puddles.",
            category: "Environmental — Hazmat"
        }
    ],
    quiz: [
        {
            q: "You arrive at a truck rollover. The truck is on its side and you see a placard with a red diamond and the number 3 at the bottom. There is a visible liquid spill and a strong odour of gasoline. Several bystanders are approaching the truck. What should you do FIRST?",
            options: [
                "Grab the first-aid kit and approach the truck to check for injured occupants",
                "Stop at a safe distance upwind/uphill, set up the cold zone, deny bystander entry, consult the ERG, and call for hazmat team. The placard indicates a flammable liquid (Class 3) — risk of fire/explosion",
                "Tell bystanders to stay back, then drive the ambulance closer to assess the driver",
                "Approach carefully from downwind so you can smell if the chemical is toxic"
            ],
            correct: 1,
            explanation: "A red placard with the number 3 indicates a Class 3 Flammable Liquid — gasoline is the most common transported flammable liquid. FIRST priority: scene safety — stop upwind/uphill, set up cold zone, deny bystander entry, consult the ERG, call for hazmat team. Do NOT approach the scene. Flammable liquids create a fire/explosion hazard — the ambulance itself could be an ignition source."
        },
        {
            q: "Multiple patients are brought to your triage area after a chemical leak. They state they were decontaminated in the warm zone. One patient has a strong chemical smell and his clothes appear wet. What should you do?",
            options: [
                "Begin treating the patient immediately — decontamination was already performed",
                "This patient has NOT been adequately decontaminated — chemical smell and wet clothes indicate residual contamination. Send the patient back to the decon team for re-decontamination. Do NOT allow a contaminated patient into the cold zone",
                "Apply a surgical mask and start treatment",
                "Give the patient clean clothes and continue assessment"
            ],
            correct: 1,
            explanation: "A patient with a persistent chemical smell and wet clothes has NOT been adequately decontaminated. Admitting this patient to the cold zone would contaminate the entire treatment area, endangering all EMS personnel and other patients. The patient must return to the warm zone for re-decontamination. The cold zone must remain clean."
        },
        {
            q: "[HARD] A firefighter is brought to your cold zone after gross decon. He is confused, salivating profusely, has muscle fasciculations, and pinpoint pupils (1 mm). HR 54, BP 88/60, RR 6, SpO₂ 82%. What toxidrome and priority treatment?",
            options: [
                "Opioid overdose — give naloxone",
                "Cholinergic (organophosphate/nerve agent) poisoning — SLUDGEM + muscle fasciculations + pinpoint pupils is diagnostic. Atropine 2 mg IV/IM (repeat until secretions dry), pralidoxime 1 g IV, diazepam for seizures. Support airway/ventilation",
                "Cyanide poisoning from smoke inhalation — give hydroxocobalamin 5 g IV",
                "Carbon monoxide poisoning — give high-flow O₂ and transport"
            ],
            correct: 1,
            explanation: "SLUDGEM + miosis + muscle fasciculations = cholinergic poisoning from organophosphates/nerve agents. Treatment: atropine (blocks muscarinic effects — 2 mg IV/IM, repeat until secretions dry, HR >80, pupils dilate), pralidoxime/2-PAM (reactivates acetylcholinesterase — 1 g IV), and diazepam (for seizures). Support the airway — RR 6 requires ventilatory support."
        },
        {
            q: "A worker is splashed in the eyes with an unknown liquid from a drum marked with a white placard, number 8, and the word 'CORROSIVE.' He has severe eye pain, tearing, and cannot open his eyes. Priority action?",
            options: [
                "Transport immediately — the eye injury requires specialist evaluation",
                "Begin copious eye irrigation with water or NS IMMEDIATELY — at least 15–20 minutes. Remove contact lenses. Use Morgan lens if available. Do NOT attempt to neutralise the acid/alkali",
                "Apply eye patches and transport",
                "Apply topical anaesthetic drops and transport"
            ],
            correct: 1,
            explanation: "A Class 8 corrosive splash to the eyes requires IMMEDIATE and PROLONGED irrigation. Time to irrigation is the single most important determinant of visual outcome. Alkali burns penetrate deeply and can cause blindness within minutes. Irrigate for at least 15–20 minutes (30–60 minutes for alkali). Do NOT attempt to neutralise — the exothermic reaction causes additional thermal burn."
        }
    ],
    critical: [
        {
            id: "crit_8_6_1",
            scenario: "You are the first emergency responder to arrive at a train derailment. One tank car has a large visible tear and is emitting a yellow-green vapour cloud drifting toward a nearby residential area. The wind is from the south-southwest at 10 mph. The tank car has a white diamond placard with the number 2.3. Several people are running away from the scene, coughing and clutching their throats. One person is lying on the ground approximately 50 feet from the leaking tank car, not moving.",
            question: "What are your immediate actions?",
            options: [
                {t: "STOP — this is a hazmat incident involving a Poisonous Gas (Class 2.3). Yellow-green vapour = likely chlorine gas. Approach from upwind and uphill (wind from SSW → approach from the NORTH). Do NOT enter the hot zone — the downed victim cannot be accessed without Level A PPE. Notify dispatch of a hazmat MCI. Set up cold zone, request hazmat team, activate MCI plan. Consult ERG (chlorine is a TIH — initial isolation 800 m for large spill). Notify law enforcement for downwind evacuation", f: "Correct — Class 2.3 (Poisonous Gas) + yellow-green vapour = chlorine. Heavier than air (2.5×), hugging the ground, moving NNE toward residential area. The downed victim is in the hot zone — attempting rescue without PPE creates a second victim. Approach only from upwind. Use ERG green pages for isolation distances. Initiate MCI protocol."},
                {t: "Approach from the south (downwind) to assess more closely. Grab the downed victim quickly and drag them to the ambulance — decon can happen later", f: "Incorrect — Approaching from downwind walks INTO the vapour cloud. Chlorine causes immediate respiratory tract irritation and pulmonary oedema. You would become another victim."}
            ],
            correct: 0,
            explanation: "Class 2.3 (Poisonous Gas) placard with yellow-green vapour is highly suggestive of chlorine gas — which causes immediate respiratory tract irritation, pulmonary oedema, and can be fatal at high concentrations. Chlorine is 2.5× heavier than air — the cloud will hug the ground and settle in low-lying areas. Wind direction SSW → NNE means the cloud is moving toward the residential area — evacuation notification is critical. ERG green pages: initial isolation distance for a large chlorine spill = 800 m radius. Downwind protective action distance at 10 mph may be 3+ km. Your role: establish command, set up cold zone upwind, request hazmat team and MCI resources, track self-evacuating patients (they will need decon and medical evaluation), and prepare to receive decontaminated patients.",
            kpi: "Recognises a Poisonous Gas (Class 2.3) hazmat incident, establishes safe approach from upwind, avoids entering the hot zone, initiates MCI procedures"
        },
        {
            id: "crit_8_6_2",
            scenario: "You are called to a farm for a worker exposed to an unknown chemical. The worker's backpack sprayer hose burst, covering his clothes and skin with pesticide concentrate. He is outside the barn, still in contaminated clothes, salivating profusely, drooling, vomiting, with involuntary muscle twitching and 'tiny' pupils. The label says 'ORGANOPHOSPHATE.' He is awake but confused and has difficulty breathing. The hazmat team is 30 minutes away.",
            question: "The patient is still contaminated. What is your plan?",
            options: [
                {t: "Cholinergic crisis from organophosphate poisoning. The scene is unsafe — the patient is still contaminated. If you lack chemical-resistant PPE, direct the patient to self-decontaminate: remove ALL clothing (cut off, do NOT pull over head), double-bag clothing, rinse entire body with copious water from a garden hose. Once decontaminated in the cold zone: high-flow O₂, atropine (if available per protocol), rapid transport. If patient cannot self-decon, wait for hazmat team", f: "Correct — Organophosphates are rapidly absorbed through the skin. Approaching without appropriate PPE exposes you. Patient self-decon (clothing removal + water rinse) is the best option if the patient is conscious. Once in the cold zone: atropine 2 mg IV/IM, repeat until secretions dry, HR >80. Be prepared for respiratory failure — suction and ventilate. Notify hospital."},
                {t: "Approach the patient immediately — he needs atropine. Contamination is secondary. Give atropine 2 mg IM, then help him decontaminate", f: "Incorrect — Organophosphates are absorbed through skin even in small amounts. You cannot help the patient if you become contaminated. Decontamination MUST precede close contact."}
            ],
            correct: 0,
            explanation: "Organophosphate poisoning is life-threatening, but scene safety comes first. Organophosphates are rapidly absorbed through skin — a shirt wet with concentrate can deliver a lethal dose through dermal absorption. Without chemical-resistant PPE (splash suit + APR with organic vapour cartridge), you cannot enter the warm zone. Patient self-decontamination is the best option if conscious: clothing removal (cut off, NOT pulled over head) + copious water rinse (tepid, low pressure). Once decontaminated: atropine 2 mg IV/IM, repeat every 5–10 minutes until secretions dry, HR >80, pupils dilate. Organophosphate atropine dosing can be VERY high (hundreds of mg — very different from ACLS dosing). Pralidoxime (2-PAM) 1 g IV over 30 minutes if available. Diazepam for seizures. Be prepared for respiratory failure — excessive secretions require aggressive suctioning and likely intubation.",
            kpi: "Maintains scene safety by not approaching a contaminated patient without appropriate PPE; directs patient self-decontamination and recognises organophosphate toxidrome"
        }
    ]
}
];
console.log("✅ c8s4-c8s6 generated");
