...
window.CURRICULUM_INDEX = [
    ...
    { id:"m1-38", num:"11", file:"m1-38", title:"Emergency Drug Reference", icon:"book", accent:"var(--accent-scope)", sections:[
        ["m1-38s1","Drug Formulary (Overview)"],
        ["m1-38s2","Drug 1 ActiMaris"],
        ["m1-38s3","Drug 2 Adenosine"],
        ["m1-38s4","Drug 3 Amiodarone"],
        ["m1-38s5","Drug 4 Aspirin"],
        ["m1-38s6","Drug 5 Atropine"],
        ["m1-38s7","Drug 6 Combivent"],
        ["m1-38s8","Drug 7 D5W"],
        ["m1-38s9","Drug 8 Dextrose 10%"],
        ["m1-38s10","Drug 9 Diazepam"],
        ["m1-38s11","Drug 10 Diclofenac"],
        ["m1-38s12","Drug 11 Diphenhydramine"],
        ["m1-38s13","Drug 12 Dopamine"],
        ["m1-38s14","Drug 13 Epinephrine"],
        ["m1-38s15","Drug 14 Ethyl Chloride"],
        ["m1-38s16","Drug 15 Furosemide"],
        ["m1-38s17","Drug 16 Glucagon"],
        ["m1-38s18","Drug 17 Glucose Paste"],
        ["m1-38s19","Drug 18 GTN"],
        ["m1-38s20","Drug 19 Haloperidol"],
        ["m1-38s21","Drug 20 Hydrocortisone"],
        ["m1-38s22","Drug 21 Hyoscine"],
        ["m1-38s23","Drug 22 Ketamine"],
        ["m1-38s24","Drug 23 Labetalol"],
        ["m1-38s25","Drug 24 Magnesium Sulphate"],
        ["m1-38s26","Drug 25 Penthrox"],
        ["m1-38s27","Drug 26 Metoclopramide"],
        ["m1-38s28","Drug 27 Midazolam"],
        ["m1-38s29","Drug 28 Morphine"],
        ["m1-38s30","Drug 29 Naloxone"],
        ["m1-38s31","Drug 30 Nefopam"],
        ["m1-38s32","Drug 31 Oxygen"],
        ["m1-38s33","Drug 32 Paracetamol"],
        ["m1-38s34","Drug 33 Pethidine"],
        ["m1-38s35","Drug 34 Racemic Epinephrine"],
        ["m1-38s36","Drug 35 Ringers Lactate"],
        ["m1-38s37","Drug 36 Salbutamol"],
        ["m1-38s38","Drug 37 Normal Saline"],
        ["m1-38s39","Drug 38 Tranexamic Acid"],
        ["m1-38s40","Drug 39 Calcium Chloride"],
        ["m1-38s41","Drug 40 Dexamethasone"],
        ["m1-38s42","Drug 41 Etomidate"],
        ["m1-38s43","Drug 42 Fentanyl"],
        ["m1-38s44","Drug 43 Ketorolac"],
        ["m1-38s45","Drug 44 Lidocaine"],
        ["m1-38s46","Drug 45 Ondansetron"],
        ["m1-38s47","Drug 46 Promethazine"],
        ["m1-38s48","Drug 47 Sodium Bicarbonate"],
        ["m1-38s49","Drug 48 Vasopressin"]
    ]}
];
