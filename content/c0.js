    ...
    sections: [
        {
            ...
            summary: `
                <div class="sum-card">
                    <h3 style="color:#0056b3;"><svg class="lucide" width="1em" height="1em" aria-hidden="true" focusable="false"><use href="../icons/sprite.svg#megaphone"/></svg> SmartCare – What's New</h3>
                    <p style="margin-bottom:15px;"><strong>Audience:</strong> Clinical & EMS professionals · <strong>Purpose:</strong> Quick guide to understand updates in the clinical curriculum framework.</p>
