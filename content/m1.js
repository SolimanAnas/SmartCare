...
window.MEDICATIONS = {
    m1: {
        id: "m1",
        title: "ActiMaris (Wound Irrigation Solution)",
    ...
    m4: {
        ...
        summary: `
            <div class="sum-card">
                ...
                <p>81 mg/tablet</p>
                <h4>Mechanism of Action</h4>
                <p>Aspirin provides antiplatelet, fever‑reducing, and pain‑relieving effects. In DCAS, aspirin is used solely for its antiplatelet properties. Aspirin blocks the cyclooxygenase enzyme, which leads to a decrease in the production of prostaglandin and thromboxane.</p>
                <h4>Indications</h4>
