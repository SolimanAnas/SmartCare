...
window.CPG_DATA = {
    ...
    sections: [
         ...
         * c6s1 â€“ Trauma Systems & Kinematics
         * â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
        {
            id: "c6s1",
            ...
            summary: `<div class="sum-card">
                ...
                <p>A <strong>trauma system</strong> is an organized, coordinated effort in a defined geographic area to deliver the full spectrum of care to injured patients â€” from prevention and prehospital care through definitive rehabilitation. The trauma system is anchored by <strong>trauma centers</strong>, which are hospitals verified by the American College of Surgeons (ACS) and designated by state or local authorities to provide specific levels of trauma care.</p>
                ...
                <table>
                    ...
                    <tbody>
                        <tr><td><strong>Level I</strong></td><td>Comprehensive regional resource â€” the highest level; provides total care from prevention through rehabilitation</td><td>24/7 in-house general surgery, ortho, neuro, anesthesia; OR teams, ICU, research &amp; teaching; â‰¥1,200 trauma patients/year or â‰¥240 ISS >15</td></tr>
                ...
                <ul>
                    <li><strong>Falls:</strong> Adult >20 ft (â‰ˆ2 stories); Child >10 ft or 2-3Ã— child's height</li>
                ...
                <ul>
                    <li><strong>Age:</strong> Adults >55 with hypotension or AMS; children â€” consider pediatric trauma center</li>
                ...
                <ol>
                    <li><strong>Vehicle hits object</strong> â€” crumple zones absorb energy; intrusion >12 in = high-energy event</li>
                    <li><strong>Body hits interior</strong> â€” steering wheel, dashboard, windshield, seat belt cause blunt trauma</li>
                    <li><strong>Organs hit body structures</strong> â€” brain hits skull (TBI, subdural), heart shears at great vessels (aortic transection), liver/spleen tear at attachments (intra-abdominal hemorrhage)</li>
                </ol>
                <h4>Laws of Physics in Trauma</h4>
                <p>KE = Â½mvÂ² â€” velocity dominates. Doubling speed <strong>quadruples</strong> energy. Rapid deceleration (<0.1 s) = massive force. Airbags and crumple zones extend deceleration time.</p>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr><td>External findings</td><td>Subtle â€” "tip of the iceberg"</td><td>Obvious wound(s), extent hidden</td></tr>
                ...
                <p><strong>Frontal MVC:</strong> Up-and-over (headâ†’chestâ†’abdomen) vs down-and-under (kneesâ†’lumbarâ†’viscus). Restrained: seat belt syndrome (clavicle/rib fx, hollow viscus injury).<br/>
                <strong>Lateral MVC:</strong> Less crumple zone â†’ more energy. Spleen (left) / liver (right) compressed against spine. Pelvic fracture common.<br/>
                <strong>Rear MVC:</strong> Whiplash â€” acceleration-deceleration cervical spine injury.<br/>
                ...
                <strong>Pedestrian vs auto:</strong> Adult: leg bumper â†’ hood (pelvis, chest, head). Child: pelvis/thigh â†’ thrown forward. Waddell's triad: head + chest/abdomen + femur.</p>
                ...
                <p><strong>Primary:</strong> Over-pressurization wave â€” tympanic membrane rupture, lung injury, bowel perforation.<br/>
                <strong>Secondary:</strong> Fragments â€” penetrating trauma.<br/>
                <strong>Tertiary:</strong> Victim thrown â€” blunt trauma, fractures.<br/>
                ...
                <div class="highlight-box" style="background:#f8d7da; border-left-color:#721c24;">
                    <strong>Critical Warning:</strong> Penetrating torso trauma with instability or peritonitis = immediate transport. "Scoop and run" â€” not "stay and play."
                </div>
            </div>`,
            ...
            flashcards: [
                ...
                },
                {
                    ...
                    answer: "(1) Physiologic â€” GCS â‰¤13, SBP <90, RR <10 or >29, need ventilatory support. (2) Anatomic â€” specific injury patterns. (3) Mechanism â€” falls >20 ft, high-risk auto crash, pedestrian struck. (4) Special considerations â€” age >55, anticoagulants, pregnancy >20 weeks, burns + trauma.",
                    category: "Trauma Systems â€” Transport Criteria"
                },
                {
                    question: "What are the three collisions in an MVC?",
                    answer: "(1) Vehicle collides with object â€” crumple zones absorb energy. (2) Body collides with interior â€” blunt trauma from steering wheel, dashboard, windshield. (3) Organs collide with body structures â€” brain hits skull, heart shears at great vessels, liver/spleen tear.",
                    category: "Kinematics â€” MVC"
                },
                {
                    question: "Why does doubling speed quadruple injury severity?",
                    answer: "KE = Â½mvÂ². Velocity is squared, so doubling speed increases crash energy by 4Ã—. A 60 mph crash releases 4Ã— more energy than a 30 mph crash.",
                    category: "Kinematics â€” Physics"
                },
                {
                    question: "What injury patterns are associated with frontal impact MVC?",
                    answer: "Up-and-over: Head hits windshield (TBI) â†’ chest hits steering wheel (sternal fx, cardiac contusion) â†’ abdomen (liver/spleen). Down-and-under: Knees hit dash (femur fx) â†’ lap belt loads lumbar spine (Chance fracture) â†’ hollow viscus rupture.",
                    category: "Kinematics â€” Injury Patterns"
                },
                {
                    question: "Distinguish blunt vs penetrating trauma energy transfer.",
                    answer: "Blunt: Energy dissipates over broad area â€” widespread but less obvious injury. Penetrating: Energy concentrated at entry point â€” injury tracks deep; external wound is the 'tip of the iceberg.'",
                    category: "Trauma â€” Blunt vs Penetrating"
                },
                {
                ...
                },
                {
                    ...
                    category: "Kinematics â€” Specific MOI"
                }
            ],
            ...
            quiz: [
                {
                    ...
                    correct: 1,
                    explanation: "In a left-sided lateral impact, the spleen is compressed against the spine â€” the most vulnerable left-sided solid organ."
                },
                {
                    ...
                    correct: 3,
                    explanation: "SBP <90 mmHg is an independent physiologic criterion. GCS â‰¤13 (not 14), RR <10 or >29 (28 is under the threshold)."
                },
                {
                    ...
                    correct: 1,
                    explanation: "Steering wheel deformity + chest wall imprint = high-energy transfer to chest. Suspect cardiac contusion, pulmonary contusion, possible great-vessel injury â€” regardless of stable vitals."
                },
                {
                    ...
                    options: [
                        "No trauma center â€” fall was not >20 ft",
                        "Transport to trauma center â€” fall >20 ft is a mechanism criterion",
                        "Transport â€” any fall >10 ft warrants trauma evaluation",
                        "Refuse transport"
                    ],
                    correct: 1,
                    explanation: "The adult fall criterion is >20 ft. At 18 ft, this is borderline â€” but clinical judgment should still prompt strong consideration for a trauma center."
                }
            ],
            ...
            critical: [
                {
                    ...
                    options: [
                        {t: "Treat for simple rib contusion â€” apply oxygen, transport non-emergently; the steering wheel contusion is likely superficial", f: "Incorrect. A steering-wheel deformity at 55 mph indicates massive energy transfer to the chest. Suspect cardiac contusion, pulmonary contusion, and possible aortic injury."},
                        {t: "Suspect cardiac contusion, bilateral pulmonary contusion, possible left hemothorax/pneumothorax, and possible aortic injury â€” apply high-flow oxygen, rapid trauma assessment, expedite transport to a Level I trauma center", f: "Correct. This patient meets both anatomic (chest wall injury) and physiologic (tachypnea, hypoxia) criteria for a trauma center."}
                    ],
                    correct: 1,
                    explanation: "Frontal impact with steering wheel deformity at 55 mph transmits massive force. Cardiac contusion â†’ dysrhythmias. Pulmonary contusion â†’ hypoxia worsening over 6-24 hours. Diminished breath sounds â†’ hemothorax/pneumothorax. Aortic transection is the 'silent killer' in high-speed deceleration.",
                ...
                },
                {
                    ...
                    options: [
                        {t: "Bilateral calcaneal fractures only â€” immobilize lower extremities, transport to closest hospital; back pain is muscular", f: "Incorrect. Axial loading from 25 ft transmits force up the skeleton. Lumbar spine fracture is highly probable. Motor weakness is a red flag for spinal cord compromise."},
                        {t: "Axial loading injury: bilateral calcaneal fractures + possible lumbar burst fracture + possible spinal cord injury â€” full spinal immobilization, rapid trauma assessment, transport to trauma center", f: "Correct. This meets MOI criterion (fall >20 ft). Motor weakness despite intact sensation suggests spinal cord compression."}
                    ],
                    correct: 1,
                ...
                },
                {
                    ...
                    options: [
                        {t: "The femur fracture is the priority â€” splint and transport to the closest hospital", f: "Incorrect. Waddell's triad in pediatric pedestrians includes head injury + chest/abdominal injury + femur fracture. Abdominal tenderness could indicate life-threatening internal injuries."},
                        {t: "Suspect Waddell's triad: head injury (chin laceration, possible TBI) + chest/abdominal injury + femur fracture â€” spinal precautions, rapid assessment, traction splint for femur, transport to a pediatric trauma center", f: "Correct. Abdominal tenderness and chest contusion raise concern for intra-abdominal and intrathoracic injury. The femur fracture may have caused significant blood loss."}
                    ],
                    correct: 1,
                    ...
                    kpi: "Pediatric pedestrian â€” Waddell's triad"
                }
            ]
        },

        /* â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
         * c6s2 â€“ Bleeding Control
         * â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
        {
            id: "c6s2",
            ...
            summary: `<div class="sum-card">
                ...
                <table>
                    ...
                    <tbody>
                        <tr><td><strong>Arterial</strong></td><td>Artery (high-pressure, oxygenated blood away from heart)</td><td>Bright red, <strong>spurts/pulsates</strong> with pulse; difficult to control</td><td>Life-threatening â€” can exsanguinate in minutes from femoral, brachial, carotid, or aorta</td></tr>
                ...
                <ol>
                    <li><strong>Direct pressure</strong> â€” Firm pressure directly over the bleeding site with sterile gauze. Maintain uninterrupted pressure for at least 10 minutes. Do NOT periodically "check" â€” this disrupts clot formation.</li>
                    <li><strong>Elevation</strong> â€” Elevate extremity above heart level (ONLY with direct pressure; elevation alone is ineffective).</li>
                    <li><strong>Pressure dressing</strong> â€” Tight roller bandage over the wound after direct pressure slows bleeding. Tight enough to maintain pressure, not so tight as to act as a tourniquet.</li>
                    <li><strong>Wound packing</strong> â€” Pack wound tightly with hemostatic or standard gauze, then direct pressure over packing. For deep/narrow wounds or junctional areas (groin, axilla, neck) where tourniquet cannot be applied.</li>
                    <li><strong>Hemostatic dressings</strong> â€” Gauze with kaolin/chitosan that accelerate clotting. Pack into wound, hold pressure for 3 minutes.</li>
                    <li><strong>Tourniquet</strong> â€” For life-threatening extremity hemorrhage not controlled by direct pressure. Apply proximal, tighten until bleeding stops.</li>
                </ol>

                <h4>Tourniquet Application</h4>
                <div class="highlight-box" style="background:#f8d7da; border-left-color:#721c24;">
                    <strong>NREMT Critical Point:</strong> Tourniquet for life-threatening extremity hemorrhage should be applied <strong>BEFORE checking distal pulses</strong>. Apply, tighten until bleeding stops, then reassess. Do NOT remove once applied â€” even if bleeding appears controlled â€” unless directed by a physician in the hospital.
                </div>
                ...
                <p><strong>Commercial (windlass):</strong> CAT, SOFT-T, SAM XT â€” proven in combat, one-hand application, consistent pressure.<br/>
                <strong>Ratchet-style:</strong> RMT â€” precise tightening, no windlass.<br/>
                <strong>Pneumatic:</strong> BP cuff â€” even pressure, adjustable, but may lose pressure.<br/>
                <strong>Improvised:</strong> Cravat + rigid object â€” less effective, higher failure risk.</p>
                ...
                <ol>
                    ...
                    <li>Secure strap, then turn windlass until bleeding STOPS. Patient will experience significant pain â€” this is expected.</li>
                    <li>Secure windlass in clip. Document time â€” write "TQ" and time on patient's forehead.</li>
                ...
                <div class="highlight-box" style="background:#f8d7da; border-left-color:#721c24;">
                    <strong>Critical Warning:</strong> Do NOT apply tourniquet over a wound â€” apply proximal. Do NOT apply over a joint. If bleeding continues after initial application, tighten further â€” do not remove and reapply. Life over limb â€” never remove prehospitally.
                </div>

                <h4>Hemostatic Dressings</h4>
                <p><strong>Kaolin-based (QuikClot Combat Gauze):</strong> Activates Factor XII (Hageman factor) â€” intrinsic coagulation pathway. Current tactical standard. Pack into wound, hold pressure 3 minutes.<br/>
                ...
                <strong>Technique:</strong> Expose wound â†’ pack gauze deep into wound directly onto bleeder â†’ pack tight layer after layer â†’ hold direct pressure for 3 full minutes â†’ apply pressure dressing over packing.</p>

                <h4>Internal Bleeding Assessment</h4>
                <p>Internal bleeding is a <strong>hidden killer</strong> â€” cannot be seen, measured directly, or packed. High index of suspicion based on mechanism, anatomy, and subtle signs.</p>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr><td><strong>Kehr's Sign</strong></td><td>LUQ pain referred to <strong>left shoulder</strong> â€” blood irritates the diaphragm's phrenic nerve (C3-5). Classic sign of <strong>splenic rupture</strong></td></tr>
                        <tr><td><strong>Tachycardia</strong></td><td>Earliest sign of hemodynamic compromise â€” heart increases rate to maintain cardiac output</td></tr>
                        ...
                        <tr><td><strong>Pallor / Cool clammy skin</strong></td><td>Peripheral vasoconstriction shunts blood to core â€” catecholamine-mediated</td></tr>
                        <tr><td><strong>Thirst / Anxiety / AMS</strong></td><td>Cerebral hypoperfusion causes restlessness, confusion, lethargy</td></tr>
                    </tbody>
                </table>

                <div class="highlight-box" style="background:#fff3cd; border-left-color:#856404;">
                    <strong>Clinical Pearl: Kehr's Sign</strong> â€” In blunt abdominal trauma (especially left-sided), left shoulder pain = splenic injury until proven otherwise. Blood tracks to left hemidiaphragm, irritating phrenic nerve. High-yield NREMT topic.
                </div>
                ...
                <div class="highlight-box" style="background:#d4edda; border-left-color:#155724;">
                    <strong>Key Concept:</strong> A femur fracture + pelvic fracture can lose 3,000-4,500 mL â€” essentially the entire adult blood volume. Recognize the mechanism, anticipate shock, and transport rapidly.
                </div>

                <h4>Pelvic Fracture Hemorrhage Control</h4>
                <p>Unstable pelvic ring disruptions (open-book, vertical shear) â†’ massive bleeding from presacral venous plexus and iliac vessels. Apply <strong>pelvic binder</strong> at greater trochanters (not iliac crest). If no commercial binder, wrap a sheet tightly at trochanter level. Do NOT repeatedly compress and release â€” each movement disrupts clot formation.</p>

                <h4>Wound Packing Technique</h4>
                <p>For <strong>junctional zones</strong> (groin, axilla, neck, shoulder) where tourniquets cannot be applied: (1) Locate bleeding source. (2) Push hemostatic gauze deep into wound directly onto bleeder. (3) Pack layer by layer until wound is filled â€” creating a tight plug. (4) Hold direct pressure for 3 full minutes. (5) Apply pressure dressing over packing.</p>

                <div class="highlight-box" style="background:#f8d7da; border-left-color:#721c24;">
                    <strong>Critical Warning:</strong> NEVER blindly clamp a bleeding vessel with a hemostat prehospitally â€” you can clamp a nerve or damage adjacent structures. Direct pressure and wound packing are safer and more effective.
                </div>
            </div>`,
            ...
            flashcards: [
                ...
                },
                {
                    ...
                    category: "Bleeding â€” External Control"
                },
                {
                    question: "What are the steps for applying a commercial windlass tourniquet?",
                    answer: "Expose â†’ place 2-3 in proximal to wound (not over joint) â†’ secure strap â†’ turn windlass until bleeding stops â†’ secure windlass â†’ document TQ time on forehead â†’ NEVER remove once applied.",
                    category: "Bleeding â€” Tourniquet"
                },
                {
                    question: "What is Kehr's sign and what does it indicate?",
                    answer: "LUQ pain referred to left shoulder â€” blood irritates phrenic nerve (C3-5). Classic sign of splenic rupture. Any left shoulder pain after abdominal trauma = splenic injury until proven otherwise.",
                    category: "Bleeding â€” Internal"
                },
                {
                    question: "How much blood can each fracture type lose?",
                    answer: "Closed femur: 1,000-1,500 mL. Pelvic: 2,000-3,000+ mL. Tibia: 500-750 mL. Humerus: 500-750 mL. Femur + pelvis combined: 3,000-4,500 mL â€” entire adult blood volume.",
                    category: "Bleeding â€” Fracture-related"
                },
                {
                    ...
                    category: "Bleeding â€” Internal Signs"
                },
                {
                    ...
                    category: "Bleeding â€” Internal Patterns"
                },
                {
                    question: "How do you properly pack a wound with hemostatic gauze?",
                    answer: "Locate bleeder â†’ push gauze deep into wound onto bleeder â†’ pack tight layer by layer until filled â†’ hold direct pressure 3 minutes â†’ apply pressure dressing. Used for junctional zones (groin, axilla, neck).",
                    category: "Bleeding â€” Wound Packing"
                }
            ],
            ...
            quiz: [
                ...
                },
                {
                    ...
                    options: ["Diaphragm muscle spasm", "Kehr's sign â€” splenic injury", "Cervical spine injury", "Anxiety hyperventilation"],
                    correct: 1,
                ...
                },
                {
                    ...
                    correct: 2,
                    explanation: "NREMT: tourniquets for life-threatening extremity hemorrhage are applied BEFORE checking distal pulses. Do NOT loosen prehospitally â€” this can cause fatal re-bleeding."
                },
                {
                    ...
                    options: ["500-750 mL", "1,000-1,500 mL", "3,000-4,500 mL", "500 mL â€” minimal loss"],
                    correct: 2,
                    explanation: "Femur fracture (up to 1,500 mL) + pelvic fracture (up to 3,000 mL) + possible intra-abdominal bleed = 3,000-4,500 mL â€” essentially the entire adult blood volume."
                }
            ],
            ...
            critical: [
                {
                    ...
                    options: [
                        {t: "Apply additional gauze and continue direct pressure another 10 minutes â€” the clot needs more time", f: "Incorrect. Arterial bleeding not controlled after 5 minutes of direct pressure is unlikely to stop without more aggressive intervention. The patient is actively hemorrhaging into shock."},
                ...
                },
                {
                    ...
                    options: [
                        {t: "The femur fracture is causing the blood loss â€” apply a traction splint and increase the fluid rate", f: "Incorrect. While the femur contributes, pelvic tenderness + high-risk mechanism suggest pelvic fracture hemorrhage is the primary driver. A traction splint alone will not address pelvic bleeding."},
                        {t: "Suspect retroperitoneal and intra-abdominal hemorrhage from pelvic fracture and solid organ injury â€” apply pelvic binder at trochanters, give second 500 mL NS bolus (permissive hypotension, target SBP ~80-90), expedite transport", f: "Correct. Pelvic fracture + femur fracture + seat belt sign = massive hemorrhage risk. Pelvic binder reduces pelvic volume and tamponades venous bleeding. Permissive hypotension avoids disrupting clots."}
                    ],
                    correct: 1,
                    explanation: "High-energy mechanism with multiple injuries. Pelvic fracture bleeding is the most immediately life-threatening â€” not controllable in the field. Pelvic binder (or sheet at trochanters) reduces pelvic volume. Permissive hypotension (SBP 80-90) â€” do not raise pressure high enough to disrupt clots.",
                    kpi: "Pelvic fracture hemorrhage recognition and management"
                },
                {
                    id: "crit_6_2_3",
                    scenario: "A 35-year-old male with a traumatic amputation of his right arm at mid-humerus from a farming accident. A bystander applied a tourniquet, but it appears loose â€” brisk bleeding continues from the stump. BP 84/50, HR 138, RR 30, barely responsive. He also has a 4 cm forearm laceration oozing dark blood.",
                    question: "The tourniquet is not controlling the bleeding from the amputation. What is your next action?",
                    options: [
                        {t: "Leave the existing tourniquet in place, apply a pressure dressing over the stump, and start aggressive fluid resuscitation to raise SBP above 100", f: "Incorrect. The tourniquet is not working. Leaving an ineffective tourniquet gives false reassurance. Aggressive fluids raising SBP >90-100 is wrong â€” permissive hypotension is preferred."},
                        {t: "Tighten the existing tourniquet further â€” if bleeding continues, apply a second tourniquet side-by-side proximal to the first. Control forearm laceration with pressure. Give 500 mL NS bolus (target SBP 80-90) and expedite transport", f: "Correct. An ineffective tourniquet must be tightened. If bleeding persists, apply a second side-by-side. Use permissive hypotension â€” enough for cerebral perfusion but not enough to disrupt clots."}
                    ],
                    correct: 1,
         ...
         * â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
        {
            ...
            summary: `<div class="sum-card">
                ...
                <p><strong>Shock</strong> is a state of inadequate tissue perfusion and oxygen delivery to meet cellular metabolic demands. It is <strong>not</strong> simply low blood pressure â€” it is circulatory failure at the cellular level. By the time hypotension develops, the patient has exhausted compensatory mechanisms and is in <strong>decompensated shock</strong>.</p>
                ...
                <div class="highlight-box" style="background:#d4edda; border-left-color:#155724;">
                    <strong>Key Concept:</strong> In trauma, <strong>hypovolemic shock from hemorrhage</strong> is most common. But always consider tension pneumothorax (obstructive) and spinal cord injury (neurogenic) â€” their treatment is completely different.
                </div>

                <h4>Hemorrhagic Shock Classification (ATLS)</h4>
                <p>Average adult blood volume â‰ˆ 5 L (70 mL/kg). Classification by % blood loss:</p>
                <table>
                    <thead>
                        <tr><th>Parameter</th><th>Class I</th><th>Class II</th><th>Class III</th><th>Class IV</th></tr>
                    </thead>
                    <tbody>
                        <tr><td><strong>% Loss</strong></td><td>â‰¤15% (&lt;750 mL)</td><td>15-30% (750-1,500 mL)</td><td>30-40% (1,500-2,000 mL)</td><td>&gt;40% (&gt;2,000 mL)</td></tr>
                ...
                <div class="highlight-box" style="background:#fff3cd; border-left-color:#856404;">
                    <strong>NREMT Exam Pearl:</strong> Know <strong>Class III</strong> (30-40% loss, 1,500-2,000 mL) â€” the threshold where compensation fails and <strong>hypotension develops</strong>. Class I and II = compensated shock. Class III = decompensated shock.
                </div>

                <h4>Compensated vs Decompensated vs Irreversible Shock</h4>
                <p><strong>Compensated (Class I-II):</strong> Body uses neuroendocrine mechanisms â€” baroreceptor reflex (â†‘ HR, â†‘ contractility, â†‘ vasoconstriction), hormonal responses (ADH, RAAS, catecholamines). Key feature: <strong>SBP is maintained</strong>. Patient may have normal BP but is tachycardic, pale, cool, diaphoretic.</p>
                ...
                <p>Goal: maintain adequate perfusion (SBP ~80-90 or palpable radial pulse) without raising BP enough to disrupt clots. Aggressive fluids â†’ dilute clotting factors, worsen coagulopathy, and can "pop the clot."<br/>
                <strong>Contraindicated in TBI:</strong> TBI patients need SBP â‰¥100-110 mmHg to maintain cerebral perfusion pressure (CPP) and prevent secondary brain injury.<br/>
                ...
                <ol>
                    <li>Hemorrhage control FIRST â€” tourniquets, pressure dressings, wound packing before anything else</li>
                    <li>High-flow Oâ‚‚ â€” titrate to SpOâ‚‚ â‰¥94%</li>
                    <li>Large-bore IV Ã— 2 (14-16G) or IO if unable</li>
                    <li>500 mL NS bolus if SBP <90 or shock signs â€” reassess, repeat once, limit 2 L</li>
                    <li>Permissive hypotension â€” unless TBI (target SBP â‰¥100-110)</li>
                    <li>Keep warm â€” hypothermia worsens coagulopathy</li>
                    <li>Scoop and run â€” definitive treatment is in the OR</li>
            ...
            flashcards: [
                {
                    ...
                    answer: "(1) Hypovolemic â€” loss of volume (MOST COMMON). (2) Distributive â€” loss of vascular tone (neurogenic, sepsis). (3) Cardiogenic â€” pump failure. (4) Obstructive â€” physical obstruction (tension PTX, tamponade).",
                    category: "Shock â€” Types"
                },
                {
                    ...
                    category: "Shock â€” Compensated vs Decompensated"
                },
                {
                    question: "Describe the four ATLS hemorrhagic shock classes.",
                    answer: "Class I: â‰¤15% (<750 mL), HR <100, normal BP. Class II: 15-30% (750-1,500 mL), HR >100-120, normal BP, narrowed pulse pressure. Class III: 30-40% (1,500-2,000 mL), HR 120-140, HYPOTENSION (SBP <90). Class IV: >40% (>2,000 mL), HR >140 or brady, profound hypotension.",
                    category: "Shock â€” Classification"
                },
                {
                    question: "What is permissive hypotension and when is it contraindicated?",
                    answer: "Target SBP ~80-90 mmHg to maintain perfusion without disrupting clots. CONTRAINDICATED in TBI â€” TBI patients need SBP â‰¥100-110 mmHg to maintain cerebral perfusion pressure.",
                    category: "Shock â€” Fluid Resuscitation"
                },
                {
                ...
                },
                {
                    ...
                    category: "Shock â€” Tension vs Tamponade"
                },
                {
                    question: "What are the key prehospital interventions for shock?",
                    answer: "(1) Hemorrhage control first. (2) High-flow Oâ‚‚. (3) Large-bore IV Ã— 2. (4) 500 mL NS if SBP <90. (5) Prevent hypothermia. (6) Scoop and run. (7) Notify trauma center.",
                    category: "Shock â€” Management"
                }
            ],
            ...
            quiz: [
                {
                    ...
                    options: ["Class I â€” <15% loss", "Class II â€” 15-30% loss (compensated)", "Class III â€” 30-40% loss (decompensated)", "Class IV â€” >40% loss"],
                    correct: 1,
                ...
                },
                {
                    ...
                    options: ["No fluids â€” BP is normal", "Permissive hypotension â€” SBP 80-90", "Aggressive fluids for SBP â‰¥100 due to head injury", "One 500 mL bolus regardless of vitals"],
                    correct: 2,
                    explanation: "GCS â‰¤13 indicates possible TBI. TBI requires SBP â‰¥100-110 to maintain CPP. Permissive hypotension is contraindicated in TBI."
                },
                {
            ...
            critical: [
                {
                    ...
                    options: [
                        {t: "Hemorrhagic shock from internal chest bleed â€” increase IV fluids, give second bolus, expedite transport", f: "Incorrect. Distended neck veins + hyperresonance + hypotension from penetrating chest wound = tension pneumothorax, not just hemorrhagic shock. Fluids alone will not resolve it."},
                        {t: "Tension pneumothorax from one-way valve mechanism â€” immediate needle decompression (14G, 2nd ICS MCL or 4th-5th ICS MAL) needed before or during transport", f: "Correct. Penetrating chest wound + progressive hypotension + distended neck veins + tympany = tension pneumothorax. Needle decompression is life-saving."}
                    ],
                    correct: 1,
                    explanation: "Tension pneumothorax: trapped air compresses vena cava (â†“ preload â†’ hypotension), heart (â†“ CO), and contralateral lung (â†“ ventilation â†’ hypoxia). Needle decompression (14G angiocath) at 2nd ICS MCL or 4th-5th ICS MAL. Rush of air confirms diagnosis.",
                ...
                },
                {
                    ...
                    options: [
                        {t: "Seat belt contusion is soft-tissue only â€” vomiting is from pain; give second bolus and continue", f: "Incorrect. Seat belt sign across abdomen is a known marker for intra-abdominal injury. Progressive distention + hypotension + vomiting = abdominal hemorrhage."},
                        {t: "Suspect intra-abdominal hemorrhage from liver/spleen/mesenteric tear â€” give second 500 mL NS bolus (permissive hypotension, SBP 80-90), prevent hypothermia, update trauma center", f: "Correct. Seat belt sign + progressive distention + falling BP = intra-abdominal hemorrhage. Permissive hypotension unless TBI. Warm the patient, limit crystalloid to 2L."}
                    ],
                    correct: 1,
                    explanation: "Seat belt sign is a well-known marker for intra-abdominal injury â€” energy through the belt can lacerate liver/spleen or tear mesenteric vessels. Deterioration from compensated to decompensated shock = ongoing hemorrhage. Permissive hypotension (SBP 80-90) prevents clot disruption.",
        ...
        /* â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
         * c6s4 â€“ Soft-Tissue Injuries & Wound Care
         * â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
        {
            id: "c6s4",
            ...
            summary: `<div class="sum-card">
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr><td><strong>Contusion (Bruise)</strong></td><td>Capillary rupture â†’ ecchymosis</td><td>Blunt impact</td><td>Ice, monitor for expanding hematoma</td></tr>
                ...
                <strong>Management:</strong> Stabilize with bulky dressings, secure with tape. Transport. If the object is in the cheek and passes through both sides, you may remove to protect airway â€” document thoroughly.</p>

                <div class="highlight-box" style="background:#d4edda; border-left-color:#155724;">
                    <strong>Key Concept:</strong> Impaled objects tamponade bleeding vessels. Removing the object releases the tamponade and can cause fatal hemorrhage. Exception: object through both cheeks (may obstruct airway) â€” remove if necessary.
                </div>
                ...
                <div class="highlight-box" style="background:#fff3cd; border-left-color:#856404;">
                    <strong>NREMT Exam Pearl:</strong> The severed part should be <strong>moist-wrapped in saline gauze, sealed in a bag, then placed in ice water</strong> (not on ice, not in dry ice). Do not allow direct ice contact â€” causes frostbite and cell death. Maximum preservation time: ~18-24 hours for digits, 6-12 hours for larger parts.
                </div>
                ...
                <p><strong>Clostridium tetani</strong> â€” toxin travels via motor nerve axons to CNS, blocks glycine/GABA release in spinal cord, causing <strong>unopposed muscle spasm</strong>.<br/>
                ...
                <strong>Tdap vaccine:</strong> Every 10 years adults; wound management: if last dose >5 years and wound is high-risk â†’ give booster. Clean minor wounds: >10 years = booster.<br/>
                ...
                <strong>Late (abscess/fasciitis):</strong> Necrosis, crepitus, systemic signs (fever, â†‘ WBC, malaise, tachycardia).<br/>
                <strong>Necrotizing fasciitis:</strong> Rapid spread, severe pain out of proportion to exam, bullae (fluid-filled blisters), gas in tissues, septic shock â€” surgical emergency.</p>

                <h4>Compartment Syndrome</h4>
                <p>Increased pressure within a closed fascial compartment â†’ reduced capillary perfusion â†’ muscle/nerve ischemia.<br/>
                ...
                <strong>Signs (6 P's):</strong> Pain (disproportionate, with passive stretch), Paresthesia (tingling/numbness), Pallor, Paralysis (late), Poikilothermia (cold), Pulselessness (very late â€” irreversible damage).<br/>
                ...
                <ol>
                    ...
                    <li>No tape directly on fragile skin â€” use wrap/stockinette instead</li>
            ...
            flashcards: [
                ...
                },
                {
                    ...
                    answer: "Wrap in sterile saline-moistened gauze â†’ place in sealed plastic bag â†’ place bag in ice water. Label with patient name and time. Do NOT use dry ice or place directly on ice. Transport with patient.",
                    category: "Amputation"
                },
                {
                    question: "When can you remove an impaled object?",
                    answer: "Exceptionally: if it obstructs the airway OR if in the cheek and prevents a pressure dressing. Otherwise NEVER remove â€” it tamponades bleeding. Stabilize with bulky dressings and transport.",
                    category: "Impaled Objects"
                },
                {
                    question: "What are the 6 P's of compartment syndrome?",
                    answer: "Pain (with passive stretch â€” earliest sign), Paresthesia, Pallor, Paralysis, Poikilothermia (cold), Pulselessness (very late â€” irreversible damage).",
                    category: "Compartment Syndrome"
                },
                {
                    question: "What is tetanus and what wound types increase risk?",
                    answer: "Caused by Clostridium tetani toxin â†’ unopposed muscle spasm (trismus/lockjaw, risus sardonicus, opisthotonos). High-risk wounds: puncture, contaminated (dirt/manure/saliva), necrotic tissue, delayed care.",
                    category: "Tetanus"
                },
                {
                ...
                },
                {
                    ...
                    answer: "Muscle damage â†’ release of myoglobin, K+, phosphate, uric acid into circulation after extrication. Main risk: acute kidney injury (AKI) from myoglobin nephrotoxicity. Treatment: aggressive IV fluids, sodium bicarbonate (alkalinizes urine), mannitol.",
            ...
            quiz: [
                ...
                },
                {
                    ...
                    options: ["Simple contusion â€” apply ice and elevate", "Nerve damage â€” assess sensation and motor", "Compartment syndrome â€” remove tight dressings, expedite transport for fasciotomy", "Bone fracture â€” splint and transport"],
                    correct: 2,
                ...
                },
                {
                    ...
                    correct: 2,
                    explanation: "Moist-saline-gauze â†’ sealed bag â†’ ice water (NOT direct ice). Direct ice causes frostbite. Submersion in saline causes maceration. Dry gauze causes desiccation."
                }
            ],
            ...
            critical: [
                {
                    ...
                    options: [
                        {t: "Remove the rebar to reduce the weight for transport, then apply a pressure dressing. The patient will need surgery anyway", f: "Incorrect. Removing the rebar will release tamponade of injured abdominal vessels â†’ massive hemorrhage. Never remove impaled objects."},
                    ...
                    correct: 1,
                    explanation: "Impaled objects act as a tamponade against injured vessels. Removing the object releases this pressure â†’ massive hemorrhage. Stabilization with bulky dressings prevents further movement and tissue damage. Never remove impaled objects (with rare airway/cheek exceptions).",
                    kpi: "Impaled object management â€” never remove unless airway obstruction"
                },
                {
                    id: "crit_6_4_2",
                ...
                {
                    id: "crit_6_4_3",
                    scenario: "A 35-year-old motorcyclist with a large degloving avulsion of the lower right leg from the knee down. An 8Ã—10 cm skin flap is hanging by a pedicle. There is active bleeding, exposed muscle, and significant contamination. BP 88/60, HR 130, RR 28.",
                    question: "What is the correct management of this avulsion?",
                    options: [
                        {t: "Cut off the hanging skin flap (it will not survive anyway), apply a tourniquet above the knee, transport", f: "Incorrect. Do NOT complete a partial avulsion. The pedicle may contain vital blood supply â€” that flap may survive. Tourniquet is too proximal for a below-knee wound; direct pressure or pressure dressing is preferred."},
                    ...
                    correct: 1,
                    explanation: "Partial avulsion with viable pedicle: the flap may survive. Gently realign, keep moist, cover. Do not complete the amputation. Tourniquet is reserved for massive hemorrhage not controlled by pressure. Multisystem trauma â€” treat for shock and transport to trauma center for surgical wound care.",
                    kpi: "Avulsion management â€” preserve pedicled flaps"
                }
            ]
        },
        /* ──────────────────────────────────────────────────────────────────────────────
