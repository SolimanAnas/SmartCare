# Node Description Batch 24 of 48
...
- "scripts_generate_sitemap": "generate_sitemap.py" | kind=code-symbol | source=scripts/generate_sitemap.py:L1 | neighbors=[53ec4c1 Merge pull request #16 ✅, 94235c6 Ship the critical hardening lis…, main()]
...
- "sw_offlinefallback": "offlineFallback()" | kind=code-symbol | source=sw.js:L190 | neighbors=[sw.js, networkFirst(), staleWhileRevalidate()]
- "sw_stalewhilerevalidate": "staleWhileRevalidate()" | kind=code-symbol | source=sw.js:L151 | neighbors=[sw.js, networkFirst(), offlineFallback()]
