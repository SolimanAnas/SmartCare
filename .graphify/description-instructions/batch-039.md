# Node Description Batch 40 of 48
...
- "app_refreshstatsbadge": "refreshStatsBadge()" | kind=code-symbol | source=app.js:L1434 | neighbors=[app.js]
- "app_registerserviceworker": "registerServiceWorker()" | kind=code-symbol | source=app.js:L68 | neighbors=[app.js]
- "app_renderbottomnav": "renderBottomNav()" | kind=code-symbol | source=app.js:L300 | neighbors=[app.js]
- "app_rendersectionnavigation": "renderSectionNavigation()" | kind=code-symbol | source=app.js:L319 | neighbors=[app.js]
